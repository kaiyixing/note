...
> 本手册涵盖第13-18章：系统服务管理、远程操作和传输、查找和搜索、备份和恢复、安全和审计、实用场景专题。
>
> 相关手册：[[Linux命令手册_第1-6章]] | [[Linux命令手册_第7-12章]] | [[Linux命令手册_第18章]] | [[Linux命令手册规划]]
>
...
- [[Linux命令手册_第7-12章]] — 进程管理、系统监控、网络配置等命令
- [[Linux命令手册_第18章]] — 实用场景专题（Docker、Git、日志分析等）
- [[面试内核调优]] — 第17章安全审计相关延伸：内核参数调优
- [[Linux 故障排查实操指南（详细步骤）]] — 系统服务与排障实践
- [[Linux 系统核心组件配置文件速查表]] — 系统配置与服务管理配合使用