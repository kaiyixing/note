...
> 本手册涵盖第1-6章：基础系统信息命令、文件和目录管理、文件内容和查看、文件权限和属性、文本处理和搜索、压缩和解压。
>
> 相关手册：[[Linux命令手册_第7-12章]] | [[Linux命令手册_第13-18章]] | [[Linux命令手册_第18章]] | [[Linux命令手册规划]]
>
...
- [[Linux 故障排查实操指南（详细步骤）]] — 结合基础命令进行系统排障
