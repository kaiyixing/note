...
高级阶段
├── 搭建 [[监控系统详解（Prometheus-Grafana）|Prometheus + Grafana]] 监控体系
├── 掌握容量规划和性能建模
├── 学习 [[面试内核调优|内核参数调优]]
└── 掌握分布式系统的性能排查
```
...
- [[面试内核调优]] — 定位瓶颈后的内核参数调优实操
- [[Linux 故障排查实操指南（详细步骤）]] — 系统故障排查完整流程
- [[监控系统详解（Prometheus-Grafana）]] — 搭建性能监控体系
- [[Kubernetes知识梳理]] — 容器环境下的资源紧张排查
- [[Linux命令手册_第7-12章]] — 进程管理、系统监控命令详解
- [[Linux 系统核心组件配置文件速查表]] — 排查涉及的配置文件路径
