---
title: 网络工程与 VLAN 规划实操指南（思科 Cisco 版本）
tags:
  - 网络/排障
  - 网络/vlan
---
...
> 前置知识：路由与交换的基础原理参见[[路由与交换的核心原理及区别]]，OSI 模型与 IP 基础参见[[秦的网络]]。
...
### 步骤 2：子网划分计算（[[面试准备/面经/大厂运维运维开发面试高频知识点总结|面试必考]]）
...
### 步骤 2：总部核心[[网络/TCP-IP详解/路由与交换的核心原理及区别|交换机]]配置（Cisco 3560）
...
### 步骤 3：总部[[网络/TCP-IP详解/路由与交换的核心原理及区别|路由器]]配置（Cisco 2901）
...
### 问题 2：跨 [[网络/TCP-IP详解/路由与交换的核心原理及区别|VLAN]] 不通
...
## 💡 [[面试准备/面经/大厂运维运维开发面试高频知识点总结|面试话术模板]]

> 更多网络面试题可参考[[面试准备/面经/面试问答]]和[[面试准备/面经/大厂运维运维开发面试高频知识点总结]]。
